...
const SideBar = ({
  ...
  return (
    <div
      className={` bg-black fixed z-20  -right-full  px-6 py-7  scrollbar md:block md:sticky md:top-28 md:ml-2 md:glassMorphism md:w-[400px] md:max-h-[calc(100vh_-_140px)] md:overflow-y-auto  ${
        isShowFilters

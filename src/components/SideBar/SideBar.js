...
const SideBar = ({
  ...
  return (
    <div
      className={` bg-black fixed z-20  -right-full  px-6 py-7  scrollbar md:block md:sticky md:top-20 md:ml-8 md:glassMorphism md:w-[250px] md:max-h-[calc(100vh_-_140px)] md:overflow-y-auto  ${
        isShowFilters
